## 🏢 Contexte
Dans le cadre de mon alternance en contrôle de gestion chez Polyexpert j'ai automatisé le reporting quotidien du CA pour deux régions.
...
- Processus reproductible et scalable (l'architecture du workflow a été adaptée pour d'autres rapports)
...
- /data_example : test réel avec données anonymisés
